 ...
 */
function formatRub(value, showZero = false) {
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatUsd(value, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatPercent(value, decimals = 1, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatWeight(value, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatCargoRate(value, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatDensity(value, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatRate(value, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
 ...
 * @returns {string} - Formatted string or placeholder
 */
function formatNumber(value, decimals = 2, showZero = false) {
  if (value === null || value === undefined || Number.isNaN(value)) {
    return '—';
  }
